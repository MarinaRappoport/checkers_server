...
/**
 * User Controller for API calls related to user (authentication and list of players)
 */
@Controller
...
public class UserController {
	...
	public @ResponseBody
	User addNewUser(@RequestBody User userNew, HttpServletResponse response) throws NoSuchAlgorithmException {
	...
	public @ResponseBody
	User verifyUser(@RequestBody User userToVerify, HttpServletResponse response) throws NoSuchAlgorithmException {
		// This returns a JSON or XML with the users
